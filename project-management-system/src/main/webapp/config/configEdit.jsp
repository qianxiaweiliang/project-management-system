...
<form action="/config/addorupdate/" data-selector="form-edit" method="post">
  <table class="table table-form">
    <tbody>
     <input type="hidden" name="id" value="${form.id}">
     <tr>
      <th><span class="help-required">*</span>配置类型 0:来源配置 1:人员配置：</th>
      <td><input class="text" type="text" name="kind" value="${form.kind}"></td>
     </tr>
     <tr>
      <th><span class="help-required">*</span>配置描述：</th>
      <td><input class="text" type="text" name="description" value="${form.description}"></td>
     </tr>
     <tr>
      <th><span class="help-required">*</span>状态 0:启用 1:禁用：</th>
      <td><input class="text" type="text" name="status" value="${form.status}"></td>
     </tr>
    </tbody>
  </table>
