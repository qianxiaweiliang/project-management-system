...
<form action="/registrationtime/addorupdate/" data-selector="form-edit" method="post">
  <table class="table table-form">
    <tbody>
     <input type="hidden" name="id" value="${form.id}">
     <tr>
      <th><span class="help-required">*</span>项目id：</th>
      <td><input class="text" type="text" name="projectId" value="${form.projectId}"></td>
     </tr>
     <tr>
      <th><span class="help-required">*</span>登记日期：</th>
      <td><input class="text" type="text" name="checkDate" value="${form.checkDate}"></td>
     </tr>
     <tr>
      <th><span class="help-required">*</span>工作时长：</th>
      <td><input class="text" type="text" name="workingTime" value="${form.workingTime}"></td>
     </tr>
     <tr>
