...
<form action="/role/addorupdate/" data-selector="form-edit" method="post">
  <table class="table table-form">
    <tbody>
     <input type="hidden" name="id" value="${form.id}">
     <tr>
      <th><span class="help-required">*</span>角色名称：</th>
      <td><input class="text" type="text" name="roleName" value="${form.roleName}"></td>
     </tr>
     <tr>
