    ...
    <table class="table-search">
      <tbody>
        <tr>
          ...
          <th>角色名称：</th>
          <td><input class="text" type="text" name="role_name" value="${queryCondition.role_name}"></td>
          <th>备注：</th>
  ...
  <table class="table table-data table-striped table-hover table-text-center">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a target="_blank" href="/role/detail/?id=${form.id}">查看</a>
    ...
    <tfoot>
      <tr>
        <td colspan="7">
          ...
          <div class="float-right"><liepin:pagingBar queryCondition="${queryCondition}" pageUrl="/role/list"/></div>
        </td>
      </tr>
    </tfoot>
  </table>
