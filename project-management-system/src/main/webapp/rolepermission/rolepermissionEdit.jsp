...
<form action="/rolepermission/addorupdate/" data-selector="form-edit" method="post">
  <table class="table table-form">
    <tbody>
     ...
     <tr>
      <th><span class="help-required">*</span>权限id：</th>
      <td><input class="text" type="text" name="permissionId" value="${form.permissionId}"></td>
     </tr>
    </tbody>
  </table>
